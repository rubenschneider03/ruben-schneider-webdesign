...
const ITEMS = [
  {
    ...
    desc: 'Besucher verstehen sofort, was Sie anbieten.',
  },
  {
    ...
    desc: 'Telefon, E-Mail oder Anfrage ohne Umwege.',
  },
  {
    ...
    desc: 'Optimiert für Kunden, die unterwegs suchen.',
  },
]
...
export default function WhatYouGetSection() {
  ...
  return (
    <section id="leistungen" ref={ref} className="scroll-mt-20 py-16 md:py-20" style={{ background: 'var(--surface)' }}>
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          {ITEMS.map((item, i) => (
            <div key={item.title}
              className={`reveal reveal-delay-${i + 1} card-lift rounded-2xl p-7 flex flex-col gap-4`}
