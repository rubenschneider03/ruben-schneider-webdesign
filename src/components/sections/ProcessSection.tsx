  ...
  return (
    <section id="ablauf" className="scroll-mt-20 py-20 md:py-24" ref={ref} style={{ background: 'var(--bg-dark)' }}>
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        <div className="reveal max-w-2xl mx-auto text-center mb-4">
        ...
        <p className="reveal reveal-delay-1 text-base leading-relaxed mb-14 max-w-xl mx-auto text-center" style={{ color: 'var(--fg-muted)' }}>
        ...
        <div className="max-w-3xl mx-auto flex flex-col gap-0">
          {STEPS.map((step, i) => (
            <div key={step.n} className={`reveal reveal-delay-${i + 1} grid grid-cols-[auto_1fr] gap-5 md:gap-7`}>
              {/* Number column */}
